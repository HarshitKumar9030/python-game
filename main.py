...
class GameDatabase:
    ...
    def save_player(self, player):
        with self.conn:
            ...
            cur.execute("""
                INSERT INTO players (name, health, attack_power, level, experience)
                VALUES (?, ?, ?, ?, ?)
            """, (player.name, player.health, player.attack_power, player.level, player.experience))
    ...
    def explore(self):
        ...
        if action == "encounter":
            ...
            if self.world.current_enemy:
                ...
                pygame_app.battle_view(self.world.current_enemy)
        elif action == "item":
